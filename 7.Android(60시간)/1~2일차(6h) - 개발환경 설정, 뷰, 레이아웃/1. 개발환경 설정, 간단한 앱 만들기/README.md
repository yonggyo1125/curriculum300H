...
- 약관 동의 항목이 나오면 [Accept]를 선택하고 [Next] 를 눌러줍니다.
...
- 마우스로 Hello World! 글자가 있는 곳을 클릭합니다. 그러면 오른쪽에 Attributes 창에 선택한 글자에 대한 여러가지 정보가 표시됩니다. 이렇게 글자를 화면에 보여주는 것을 텍스트뷰(TextView)라고 부릅니다.
...
- 다운로드한 드라이버 설치 파일을 실행하여 설치를 시작합니다.
